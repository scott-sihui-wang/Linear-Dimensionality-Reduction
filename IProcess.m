function [err,ttl,mis_rate,p_err]=IProcess(filename,ext,sorting_column,sorting_method,num_of_class,row_bound,column_bound,prior_enable,truncate_class,dim,r_dim,divergence,m_iter,tol,solver)
    ...
    proj=FID(means,covs,prior,divergence,dim,r_dim,m_iter,tol,solver);
